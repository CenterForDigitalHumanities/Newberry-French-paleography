...
<script type="text/javascript"> 
	...
	function formatPopup(feature, layer) {
	    ...
	    if (feature.properties){
	        ...
	        if(features.properties.identifier){
	        	popupContent += `<div class="featureInfo"> <label>Identifier</label> ${feature.properties.region} </div>`
	        }
	        if(features.properties.doclink1){
	        	popupContent += `<div class="featureInfo"> <label>Link</label> <a href="${features.properties.doclink1}">${features.properties.doclink1}</a> </div>`
	        }
