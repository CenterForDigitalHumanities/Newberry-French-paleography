...
<p><figure style="float:right;text-align:center;box-shadow:1px 1px 3px rgba(0,0,0,.3);background-color:#ddd; color:black;max-width:136px;padding:.5em;">
...
</figure>Visiting the page for [Manuscripts]({{"/www/manuscripts.html" | relative_url}}) will show a list of all manuscripts in the collection. Under each thumbnail is a "View" button, which will take you to the page for the manuscript, where you can navigate the digital facsimile, view related information and documents, or begin a transcription project.</p>
